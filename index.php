...
<head>
    ...
    <title>Advanced Research Lab | IUB</title>
...
<body>
    ...
    <div class="container">
        <!-- About Section -->
        <section id="about" class="research-section">
            <h2>About the Lab</h2>
            <img src="https://images.unsplash.com/photo-1563986768609-322da13575f3?ixlib=rb-1.2.1&auto=format&fit=crop&w=1200&q=80" alt="Lab Photo" style="width:100%; max-height:400px; object-fit:cover; border-radius:8px; margin-bottom:1.5rem; border: 2px solid var(--primary-green);">
            <p>Welcome to the <strong style="color: var(--neon-green);">Advanced Research Lab (ARL)</strong> at Independent University, Bangladesh (IUB). We focus on interdisciplinary research in robotics, AI, and space technology to solve real-world problems.</p>
            <p>Founded in 2010, our lab collaborates with industry leaders and academic partners worldwide to push the boundaries of scientific discovery.</p>
            <a href="#" class="btn">Lab Brochure (PDF)</a>
        </section>
        ...
        <!-- Team -->
        <section id="team" class="research-section">
            <h2>Our Team</h2>
            <div class="team-grid">
        ...
        <!-- News -->
        <section id="news" class="research-section">
            <h2>Lab News</h2>
            <div class="news-item">
                <h3>1. IUB Bongomarin Finished in Top 15 in SAUVC</h3>
                <p><em>April 2024</em></p>
                <p>Our autonomous underwater vehicle team achieved a top-15 finish in the prestigious Singapore AUV Challenge, competing against top universities worldwide.</p>
                <a href="https://iub.ac.bd/news-and-events/news-and-media-archive/2024-April/6612b45bc6bfbf095a22ab05" class="btn btn-outline">Read More</a>
            </div>
            <div class="news-item">
                <h3>2. IUB FabSat Team Scores 96.64% in CanSat Competition</h3>
                <p><em>March 2024</em></p>
                <p>Our CanSat team aced the Critical Design Review round with near-perfect scores, advancing to the final competition phase.</p>
                <a href="http://www.cse.iub.edu.bd/news/29" class="btn btn-outline">Read More</a>
            </div>
        </section>

        <!-- Contact -->
        <section id="contact" class="research-section">
            <h2>Contact Us</h2>
            <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 2rem; margin-top: 2rem;">
                <div>
                    <h3 style="color: var(--neon-green); margin-bottom: 1rem;">Email</h3>
                    <p><a href="mailto:arl@iub.edu.bd" style="color: var(--primary-green);">arl@iub.edu.bd</a></p>
                </div>
                <div>
                    <h3 style="color: var(--neon-green); margin-bottom: 1rem;">Address</h3>
                    <p>Department of CSE, Independent University, Bangladesh (IUB), Plot 16, Block B, Aftabuddin Ahmed Road, Bashundhara, Dhaka</p>
                </div>
                <div>
    ...
    <footer>
        ...
        <p>&copy; 2024 Advanced Research Lab | Independent University, Bangladesh (IUB)</p>
        <p>
            <a href="#" style="color: var(--primary-green); text-decoration: none; margin: 0 10px;">Privacy Policy</a> | 
            <a href="#" style="color: var(--primary-green); text-decoration: none; margin: 0 10px;">Accessibility</a> | 
            <a href="#" style="color: var(--primary-green); text-decoration: none; margin: 0 10px;">Careers</a>
        </p>
    </footer>
</body>
</html>